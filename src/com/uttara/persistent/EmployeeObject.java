...
public class EmployeeObject {
	...
	public static void main(String[] args) {
		List<Pen> al =Arrays.asList(new Pen("red",32,"reynolds"),new Pen("yellow",32,"dot"),new Pen("green",33,"balpen"),new Pen("blue",53,"inkpen"));
		List<Pen> p = al.stream().filter(e->e.getBrand().equalsIgnoreCase("reynolds")).filter(e->e.getPrice()>30||e.getPrice()<50).collect(Collectors.toList());
